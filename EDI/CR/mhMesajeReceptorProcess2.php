...
Datos calculados:
	...
	$NumeroConsecutivoReceptor = Numeración consecutiva de los mensajes de confirmación. Formato: d{20,20}.
*/
...
echo '<br /><pre>$xmlComprobante = ', str_replace('<', '&lt;',  $_POST['xmlComprobante']), '</pre>';//***********************************************************************************
...
echo '<br /><pre>$xmlFile = ', str_replace('<', '&lt;', $xmlFile), '</pre>';//***********************************************************************************
...
echo 'function signCE=', signCE(
	...
	base64_encode($xmlFile));// Este debe ser el XML que se va a firmar, pero debe ir en base64
